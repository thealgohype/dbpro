...
def LLMChain(model_name: str, query: str) -> str:
    ...
    if model_name == "gpt-3.5-turbo":
        llm =ChatOpenAI(model="gpt-3.5-turbo", temperature=0.7, api_key=os.getenv('OAI_API_KEY'))
        ...
        llm = ChatGoogleGenerativeAI(model="gemini-pro", temperature=0.7, google_api_key=os.getenv('GEMINI_API_KEY'))
